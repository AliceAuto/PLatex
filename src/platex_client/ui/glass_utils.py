...
class MacTitleBar(QWidget):
    ...
    def paintEvent(self, event):
        ...
        fill = _lerp_color((30, 30, 48, 35), (240, 242, 252, 230), self._theme_blend)
...
_THEME_TOKENS: dict[str, tuple[tuple[int, ...], tuple[int, ...]]] = {
    "bg_content": ((30, 30, 48, 35), (240, 242, 252, 245)),
    "bg_titlebar_fill": ((30, 30, 48, 35), (240, 242, 252, 230)),
    "border_titlebar_line": ((255, 255, 255, 20), (0, 0, 0, 25)),
    "text_title": ((210, 218, 240, 230), (20, 25, 50, 245)),
    "bg_segment": ((50, 52, 78, 80), (205, 210, 228, 200)),
    "text_segment": ((180, 190, 215, 200), (40, 45, 70, 220)),
    "bg_segment_checked": ((80, 85, 120, 160), (160, 168, 200, 210)),
    "text_segment_checked": ((235, 240, 255, 240), (15, 20, 55, 245)),
    "bg_segment_hover": ((60, 62, 90, 100), (190, 196, 218, 160)),
    "text_segment_hover": ((200, 210, 230, 220), (35, 40, 65, 235)),
    "border_content": ((255, 255, 255, 18), (0, 0, 0, 25)),
    "bg_tab": ((50, 52, 78, 100), (210, 215, 235, 180)),
    "text_tab": ((180, 190, 215, 200), (40, 45, 70, 220)),
    "border_tab": ((255, 255, 255, 10), (0, 0, 0, 18)),
    "bg_tab_selected": ((60, 62, 92, 140), (165, 172, 208, 200)),
    "text_tab_selected": ((160, 200, 245, 255), (10, 45, 120, 255)),
    "border_tab_selected": ((140, 180, 230, 50), (20, 70, 150, 70)),
    "bg_tab_hover": ((58, 60, 88, 120), (195, 200, 222, 170)),
    "text_tab_hover": ((160, 175, 210, 230), (35, 45, 80, 240)),
    "bg_pane": ((30, 30, 48, 50), (230, 234, 248, 200)),
    "bg_btn": ((50, 52, 78, 120), (210, 215, 235, 220)),
    "text_btn": ((180, 190, 215, 230), (30, 35, 60, 245)),
    "border_btn": ((255, 255, 255, 18), (0, 0, 0, 22)),
    "bg_btn_hover": ((65, 68, 100, 160), (185, 192, 218, 240)),
    "border_btn_hover": ((140, 180, 230, 70), (20, 70, 150, 80)),
    "text_btn_hover": ((210, 220, 240, 250), (20, 30, 60, 250)),
    "bg_btn_pressed": ((35, 37, 58, 160), (170, 178, 208, 240)),
    "border_btn_pressed": ((140, 180, 230, 90), (20, 70, 150, 100)),
    "text_btn_pressed": ((170, 180, 210, 230), (25, 35, 65, 245)),
    "bg_btn_disabled": ((40, 42, 62, 80), (200, 205, 220, 100)),
    "text_btn_disabled": ((90, 95, 120, 140), (140, 145, 165, 160)),
    "border_btn_disabled": ((255, 255, 255, 6), (0, 0, 0, 8)),
    "bg_primary": ((0, 122, 255, 150), (0, 100, 220, 190)),
    "text_primary_btn": ((255, 255, 255, 240), (255, 255, 255, 245)),
    "border_primary": ((0, 122, 255, 100), (0, 100, 220, 130)),
    "bg_primary_hover": ((20, 140, 255, 190), (10, 120, 240, 220)),
    "border_primary_hover": ((20, 140, 255, 140), (10, 120, 240, 170)),
    "bg_primary_pressed": ((0, 100, 220, 190), (0, 85, 200, 220)),
    "bg_danger": ((255, 69, 58, 130), (220, 50, 40, 160)),
    "text_danger": ((255, 255, 255, 230), (255, 255, 255, 240)),
    "border_danger": ((255, 69, 58, 80), (220, 50, 40, 110)),
    "bg_danger_hover": ((255, 55, 45, 180), (200, 40, 30, 200)),
    "border_danger_hover": ((255, 55, 45, 130), (200, 40, 30, 150)),
    "bg_danger_pressed": ((220, 50, 40, 180), (180, 35, 25, 200)),
    "text_yaml": ((140, 180, 230, 200), (15, 60, 140, 220)),
    "text_yaml_hover": ((170, 200, 240, 240), (10, 50, 125, 250)),
    "text_yaml_checked": ((120, 165, 225, 240), (10, 45, 115, 250)),
    "text_checkbox": ((180, 190, 215, 230), (30, 35, 60, 245)),
    "border_checkbox": ((140, 180, 230, 70), (20, 70, 150, 80)),
    "bg_checkbox": ((50, 52, 78, 100), (210, 215, 235, 200)),
    "bg_checkbox_checked": ((0, 122, 255, 170), (0, 100, 220, 200)),
    "border_checkbox_checked": ((0, 122, 255, 150), (0, 100, 220, 180)),
    "border_checkbox_hover": ((140, 180, 230, 120), (20, 70, 150, 130)),
    "text_label": ((190, 200, 225, 230), (30, 35, 60, 245)),
    "text_section": ((140, 180, 230, 240), (15, 55, 130, 250)),
    "bg_combo": ((50, 52, 78, 120), (210, 215, 235, 220)),
    "text_combo": ((180, 190, 215, 230), (30, 35, 60, 245)),
    "border_combo": ((255, 255, 255, 18), (0, 0, 0, 22)),
    "border_combo_hover": ((140, 180, 230, 70), (20, 70, 150, 80)),
    "arrow_combo": ((140, 180, 230, 150), (20, 70, 150, 180)),
    "bg_combo_dropdown": ((30, 30, 48, 220), (245, 247, 253, 250)),
    "text_combo_dropdown": ((180, 190, 215, 230), (30, 35, 60, 245)),
    "border_combo_dropdown": ((140, 180, 230, 35), (0, 0, 0, 30)),
    "bg_combo_selected": ((0, 122, 255, 70), (0, 100, 220, 60)),
    "text_combo_selected": ((220, 230, 250, 240), (255, 255, 255, 245)),
    "bg_lineedit": ((50, 52, 78, 120), (210, 215, 235, 220)),
    "text_lineedit": ((180, 190, 215, 230), (30, 35, 60, 245)),
    "border_lineedit": ((255, 255, 255, 18), (0, 0, 0, 22)),
    "border_lineedit_hover": ((140, 180, 230, 70), (20, 70, 150, 80)),
    "border_lineedit_focus": ((0, 122, 255, 140), (0, 100, 220, 170)),
    "bg_lineedit_ro": ((30, 30, 48, 100), (225, 228, 240, 160)),
    "text_lineedit_ro": ((140, 150, 175, 170), (100, 105, 130, 190)),
    "bg_plaintext": ((20, 20, 34, 140), (225, 230, 245, 220)),
    "text_plaintext": ((180, 190, 215, 230), (30, 35, 60, 245)),
    "border_plaintext": ((255, 255, 255, 10), (0, 0, 0, 15)),
    "bg_plaintext_sel": ((0, 122, 255, 50), (0, 100, 220, 60)),
    "text_plaintext_sel": ((220, 230, 250, 240), (255, 255, 255, 245)),
    "scrollbar_handle": ((100, 110, 140, 80), (130, 138, 162, 100)),
    "scrollbar_handle_hover": ((0, 122, 255, 120), (0, 100, 220, 140)),
    "bg_msgbox": ((30, 30, 48, 230), (242, 244, 252, 250)),
    "text_msgbox": ((180, 190, 215, 230), (30, 35, 60, 245)),
    "bg_msgbox_btn": ((50, 52, 78, 150), (210, 215, 235, 230)),
    "text_msgbox_btn": ((180, 190, 215, 230), (30, 35, 60, 245)),
    "border_msgbox_btn": ((255, 255, 255, 18), (0, 0, 0, 22)),
    "bg_msgbox_btn_hover": ((65, 68, 100, 190), (185, 192, 218, 250)),
    "border_msgbox_btn_hover": ((140, 180, 230, 70), (20, 70, 150, 80)),
    "bg_tooltip": ((30, 30, 48, 220), (248, 250, 255, 250)),
    "text_tooltip": ((180, 190, 215, 230), (30, 35, 60, 245)),
    "border_tooltip": ((140, 180, 230, 45), (0, 0, 0, 30)),
    "text_groupbox": ((140, 180, 230, 190), (15, 55, 130, 220)),
    "border_groupbox": ((255, 255, 255, 12), (0, 0, 0, 18)),
    "slider_groove": ((255, 255, 255, 20), (0, 0, 0, 30)),
    "slider_handle": ((0, 122, 255, 170), (0, 100, 220, 200)),
    "slider_handle_hover": ((20, 140, 255, 220), (10, 120, 240, 230)),
    "bg_hotkey_box": ((40, 42, 64, 80), (215, 220, 238, 180)),
    "border_hotkey_box": ((255, 255, 255, 12), (0, 0, 0, 18)),
    "text_hotkey_box": ((190, 200, 225, 230), (30, 35, 60, 245)),
    "text_hotkey_title": ((140, 180, 230, 210), (15, 55, 130, 230)),
    "text_hotkey_label": ((160, 170, 195, 190), (60, 65, 90, 220)),
    "bg_popup": ((30, 30, 48, 35), (240, 242, 252, 245)),
    "border_popup": ((140, 180, 230, 50), (20, 70, 150, 70)),
    "text_popup_title": ((140, 180, 230, 240), (15, 55, 130, 250)),
    "text_popup_body": ((190, 200, 225, 230), (30, 35, 60, 245)),
    "bg_log": ((18, 18, 30, 140), (225, 230, 248, 220)),
    "text_log": ((148, 196, 152, 220), (25, 100, 35, 240)),
    "border_log": ((255, 255, 255, 8), (0, 0, 0, 12)),
    "bg_plugin_list": ((25, 25, 40, 120), (220, 225, 240, 220)),
    "border_plugin_list": ((255, 255, 255, 10), (0, 0, 0, 15)),
    "text_plugin_header": ((140, 180, 230, 220), (15, 55, 130, 240)),
    "bg_plugin_item_selected": ((0, 122, 255, 50), (0, 100, 220, 60)),
    "bg_plugin_item_hover": ((60, 62, 90, 60), (195, 200, 222, 120)),
    "border_plugin_item": ((255, 255, 255, 6), (0, 0, 0, 8)),
    "text_plugin_item_name": ((210, 220, 240, 230), (20, 25, 50, 245)),
    "text_plugin_item_desc": ((140, 150, 175, 190), (80, 85, 110, 210)),
    "text_plugin_detail_name": ((140, 180, 230, 240), (15, 55, 130, 250)),
    "text_plugin_detail_desc": ((160, 170, 195, 200), (60, 65, 90, 230)),
    "bg_plugin_separator": ((255, 255, 255, 12), (0, 0, 0, 15)),
    "text_plugin_empty": ((100, 110, 140, 160), (120, 125, 145, 180)),
